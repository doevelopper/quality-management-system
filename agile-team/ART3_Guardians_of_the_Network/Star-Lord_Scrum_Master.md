# Star-Lord — Scrum Master | Guardians of the Network (ART3)
...
### SMART mission
- Specific: Execute scrum master responsibilities for Guardians of the Network, ensuring alignment to architecture, roadmap, and ceremonies.
- Measurable: Deliver agreed outcomes per sprint/PI; meet KPIs defined below; complete integration points on schedule.
- Achievable: Leverage team capabilities (Mesh networking, P2P protocol developers) and skills (Space Communication, Team Coordination, Improvisation), escalating blockers early.
...
### INVEST user story
As Star-Lord (Scrum Master), I will plan and deliver my responsibilities so that Guardians of the Network achieves its sprint and PI objectives.
...
- Valuable: Outcomes increase capability, quality, or flow for Guardians of the Network.
...
### Acceptance criteria
- Responsibilities delivered: Facilitates inter-drone communication team
