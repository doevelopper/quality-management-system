# Adam Strange — Satellite Communication Engineer | Guardians Communication (ART 3)


## SMART mission
- Specific: Deliver high-quality outcomes as Satellite Communication Engineer for Guardians Communication, aligned to backlog priorities and integration needs.
...
- Relevant: Directly advances Guardians Communication's specializations (RF Engineering, Satellite Comm, Ground-to-Air) within ART 3.
- Time-bound: Operate on a two-week sprint cadence with daily reporting and PI boundary commitments.

## INVEST working story
As Adam Strange (Satellite Communication Engineer), I will decompose work into small, testable tasks that deliver value for Guardians Communication and can be estimated and negotiated with stakeholders.
...
- Valuable: Outcomes enhance Guardians Communication's capabilities (RF Engineering, Satellite Comm, Ground-to-Air).
...
- Quality (defect rate/rework related to Satellite Communication Engineer)
