# Oracle — Quantum Security Engineer | Watchmen Response (ART 4)
...
As Oracle (Quantum Security Engineer), I will decompose work into small, testable tasks that deliver value for Watchmen Response and can be estimated and negotiated with stakeholders.
