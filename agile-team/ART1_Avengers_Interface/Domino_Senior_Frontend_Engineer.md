# Domino — Senior Frontend Engineer | Avengers Interface (ART 1)
...
As Domino (Senior Frontend Engineer), I will decompose work into small, testable tasks that deliver value for Avengers Interface and can be estimated and negotiated with stakeholders.
