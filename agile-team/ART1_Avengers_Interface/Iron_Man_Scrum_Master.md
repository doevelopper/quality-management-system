# Iron Man — Scrum Master | Avengers Interface (ART1)
...
- Achievable: Leverage team capabilities (UI/UX developers, Mission Planning specialists) and skills (Process Innovation, Team Facilitation, Technology Integration), escalating blockers early.
...
### INVEST user story
As Iron Man (Scrum Master), I will plan and deliver my responsibilities so that Avengers Interface achieves its sprint and PI objectives.
...
### Acceptance criteria
- Responsibilities delivered: Facilitates sprints, coaches team, removes blockers
