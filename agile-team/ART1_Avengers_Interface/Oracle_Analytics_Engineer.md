# Oracle — Analytics Engineer | Avengers Interface (ART 1)
...
As Oracle (Analytics Engineer), I will decompose work into small, testable tasks that deliver value for Avengers Interface and can be estimated and negotiated with stakeholders.
