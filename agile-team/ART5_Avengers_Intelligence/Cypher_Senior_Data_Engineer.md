# Cypher — Senior Data Engineer | Avengers Intelligence (ART 5)
...
As Cypher (Senior Data Engineer), I will decompose work into small, testable tasks that deliver value for Avengers Intelligence and can be estimated and negotiated with stakeholders.
