# Spider-Gwen — Senior UI/UX Engineer | Justice League Command (ART 1)
...
As Spider-Gwen (Senior UI/UX Engineer), I will decompose work into small, testable tasks that deliver value for Justice League Command and can be estimated and negotiated with stakeholders.
