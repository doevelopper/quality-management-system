# Barbara Gordon — QA Engineer | Justice League Command (ART 1)


## SMART mission
- Specific: Deliver high-quality outcomes as QA Engineer for Justice League Command, aligned to backlog priorities and integration needs.
...
As Barbara Gordon (QA Engineer), I will decompose work into small, testable tasks that deliver value for Justice League Command and can be estimated and negotiated with stakeholders.
...
- Quality (defect rate/rework related to QA Engineer)
