# Moneypenny — Solution Management | Large Solution


## Role context
- Skills: Requirements Management, Stakeholder Coordination, Process Excellence
- Responsibilities: Manage solution backlog, Coordinate with Product Managers, Ensure traceability, Facilitate ceremonies
- Straight line reports: M
- Dotted line reports: All ART Product Managers
- Key relationships: Q, Hermes

## SMART mission
- Specific: Deliver solution management outcomes for Large Solution, aligned with strategy and governance responsibilities.
- Measurable: Meet KPIs and review checkpoints each sprint/PI; close dependencies and decisions on time.
- Achievable: Leverage relationships (Q, Hermes) and reporting lines to remove blockers.
...
As Moneypenny (Solution Management), I will structure initiatives and decisions so that they are independent, negotiable, valuable, estimable, small (incremental), and testable via objective criteria.
