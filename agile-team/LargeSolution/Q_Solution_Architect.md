# Q — Solution Architect | Large Solution


## Role context
- Skills: Systems Architecture, Technology Innovation, Engineering Excellence
- Responsibilities: Define system architecture, Ensure architectural coherence, Manage architectural runway, Provide tech guidance
- Straight line reports: M
- Dotted line reports: All ART System Architects
- Key relationships: All Marvel/DC technical leads, Athena

## SMART mission
- Specific: Deliver solution architect outcomes for Large Solution, aligned with strategy and governance responsibilities.
- Measurable: Meet KPIs and review checkpoints each sprint/PI; close dependencies and decisions on time.
- Achievable: Leverage relationships (All Marvel/DC technical leads, Athena) and reporting lines to remove blockers.
...
As Q (Solution Architect), I will structure initiatives and decisions so that they are independent, negotiable, valuable, estimable, small (incremental), and testable via objective criteria.
