# M — Solution Train Engineer | Large Solution


## Role context
- Skills: Program Management, Strategic Coordination, Risk Management
- Responsibilities: Coordinate all ARTs, Manage dependencies, Facilitate Solution PI Planning, Escalate impediments
- Straight line reports: Zeus
- Dotted line reports: All ART Release Train Engineers
- Key relationships: Q, Moneypenny, All superhero team leaders

## SMART mission
- Specific: Deliver solution train engineer outcomes for Large Solution, aligned with strategy and governance responsibilities.
- Measurable: Meet KPIs and review checkpoints each sprint/PI; close dependencies and decisions on time.
- Achievable: Leverage relationships (Q, Moneypenny, All superhero team leaders) and reporting lines to remove blockers.
...
As M (Solution Train Engineer), I will structure initiatives and decisions so that they are independent, negotiable, valuable, estimable, small (incremental), and testable via objective criteria.
