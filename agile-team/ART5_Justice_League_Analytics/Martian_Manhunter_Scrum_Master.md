# Martian Manhunter — Scrum Master | Justice League Analytics (ART5)
...
- Achievable: Leverage team capabilities (Data pipeline engineers, ETL specialists) and skills (Telepathy (Data Reading), Shape Shifting (Data Transformation), Investigation), escalating blockers early.
...
### INVEST user story
As Martian Manhunter (Scrum Master), I will plan and deliver my responsibilities so that Justice League Analytics achieves its sprint and PI objectives.
...
### Acceptance criteria
- Responsibilities delivered: Facilitates data engineering team
