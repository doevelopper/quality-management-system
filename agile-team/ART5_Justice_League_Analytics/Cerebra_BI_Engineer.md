# Cerebra — BI Engineer | Justice League Analytics (ART 5)


## SMART mission
- Specific: Deliver high-quality outcomes as BI Engineer for Justice League Analytics, aligned to backlog priorities and integration needs.
...
As Cerebra (BI Engineer), I will decompose work into small, testable tasks that deliver value for Justice League Analytics and can be estimated and negotiated with stakeholders.
...
- Quality (defect rate/rework related to BI Engineer)
