# Mr. Terrific — End-to-End Testing Engineer | Justice League Validation (ART 7)
...
As Mr. Terrific (End-to-End Testing Engineer), I will decompose work into small, testable tasks that deliver value for Justice League Validation and can be estimated and negotiated with stakeholders.
