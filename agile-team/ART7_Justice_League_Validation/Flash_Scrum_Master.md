# Flash — Scrum Master | Justice League Validation (ART7)
...
- Achievable: Leverage team capabilities (System integration engineers, Interface testing specialists) and skills (Super Speed (Rapid Testing), Time Manipulation (Schedule Management), Precision), escalating blockers early.
...
### INVEST user story
As Flash (Scrum Master), I will plan and deliver my responsibilities so that Justice League Validation achieves its sprint and PI objectives.
...
### Acceptance criteria
- Responsibilities delivered: Facilitates system integration team
