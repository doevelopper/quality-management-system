# Athena — Portfolio Architect | Portfolio


## Role context
- Skills: Strategic Planning, Technology Architecture, Risk Assessment
- Responsibilities: Define enterprise architecture, Technology synergies, Strategic guidance, Technology roadmap
- Straight line reports: Zeus
- Dotted line reports: All Solution Architects
- Key relationships: M (Solution Train Engineer)

## SMART mission
- Specific: Deliver portfolio architect outcomes for Portfolio, aligned with strategy and governance responsibilities.
- Measurable: Meet KPIs and review checkpoints each sprint/PI; close dependencies and decisions on time.
- Achievable: Leverage relationships (M (Solution Train Engineer)) and reporting lines to remove blockers.
...
As Athena (Portfolio Architect), I will structure initiatives and decisions so that they are independent, negotiable, valuable, estimable, small (incremental), and testable via objective criteria.
