# Zeus — Portfolio Epic Owner | Portfolio


## Role context
- Skills: Strategic Vision, Ultimate Decision Making, Resource Allocation
- Responsibilities: Define business strategy, Approve funding, Resolve conflicts, Ensure compliance
- Straight line reports: All Large Solution Level teams
- Dotted line reports: External stakeholders
- Key relationships: Board of Directors, Regulatory Bodies

## SMART mission
- Specific: Deliver portfolio epic owner outcomes for Portfolio, aligned with strategy and governance responsibilities.
- Measurable: Meet KPIs and review checkpoints each sprint/PI; close dependencies and decisions on time.
- Achievable: Leverage relationships (Board of Directors, Regulatory Bodies) and reporting lines to remove blockers.
...
As Zeus (Portfolio Epic Owner), I will structure initiatives and decisions so that they are independent, negotiable, valuable, estimable, small (incremental), and testable via objective criteria.
