# Hermes — Portfolio Coordinator | Portfolio


## Role context
- Skills: Communication, Stakeholder Management, Market Intelligence
- Responsibilities: Portfolio communication, External stakeholder mgmt, Portfolio events, Market intelligence
- Straight line reports: Zeus
- Dotted line reports: All Large Solution Level teams
- Key relationships: External partners, Customers

## SMART mission
- Specific: Deliver portfolio coordinator outcomes for Portfolio, aligned with strategy and governance responsibilities.
- Measurable: Meet KPIs and review checkpoints each sprint/PI; close dependencies and decisions on time.
- Achievable: Leverage relationships (External partners, Customers) and reporting lines to remove blockers.
...
As Hermes (Portfolio Coordinator), I will structure initiatives and decisions so that they are independent, negotiable, valuable, estimable, small (incremental), and testable via objective criteria.
