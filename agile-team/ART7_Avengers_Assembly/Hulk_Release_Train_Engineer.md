# Hulk — Release Train Engineer | Avengers Assembly (ART7)
...
- Team: Avengers Assembly

### SMART mission
- Specific: Execute release train engineer responsibilities for Avengers Assembly, ensuring alignment to architecture, roadmap, and ceremonies.
- Measurable: Deliver agreed outcomes per sprint/PI; meet KPIs defined below; complete integration points on schedule.
- Achievable: Leverage team capabilities (cross-functional team) and skills (Incredible Strength (System Stress Testing), Transformation (Adaptive Management), Persistence), escalating blockers early.
...
### INVEST user story
As Hulk (Release Train Engineer), I will plan and deliver my responsibilities so that Avengers Assembly achieves its sprint and PI objectives.
...
- Valuable: Outcomes increase capability, quality, or flow for Avengers Assembly.
...
### Acceptance criteria
- Responsibilities delivered: Integration ART coordination, system-level testing management
