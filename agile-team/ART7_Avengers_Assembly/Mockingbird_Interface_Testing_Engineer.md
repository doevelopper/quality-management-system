# Mockingbird — Interface Testing Engineer | Avengers Assembly (ART 7)
...
As Mockingbird (Interface Testing Engineer), I will decompose work into small, testable tasks that deliver value for Avengers Assembly and can be estimated and negotiated with stakeholders.
