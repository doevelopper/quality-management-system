# Ant-Man — System Architect | Avengers Assembly (ART7)
...
### SMART mission
- Specific: Execute system architect responsibilities for Avengers Assembly, ensuring alignment to architecture, roadmap, and ceremonies.
- Measurable: Deliver agreed outcomes per sprint/PI; meet KPIs defined below; complete integration points on schedule.
- Achievable: Leverage team capabilities (cross-functional team) and skills (Size Manipulation (Micro/Macro System Views), Quantum Realm (Deep System Understanding), Precision), escalating blockers early.
...
### INVEST user story
As Ant-Man (System Architect), I will plan and deliver my responsibilities so that Avengers Assembly achieves its sprint and PI objectives.
...
### Acceptance criteria
- Responsibilities delivered: Integration architecture, test frameworks, system validation
