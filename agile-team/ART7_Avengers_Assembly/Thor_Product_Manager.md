# Thor — Product Manager | Avengers Assembly (ART7)
...
### SMART mission
- Specific: Execute product manager responsibilities for Avengers Assembly, ensuring alignment to architecture, roadmap, and ceremonies.
- Measurable: Deliver agreed outcomes per sprint/PI; meet KPIs defined below; complete integration points on schedule.
- Achievable: Leverage team capabilities (cross-functional team) and skills (God of Thunder (Power Integration), Bridge Between Worlds (System Integration), Leadership), escalating blockers early.
...
### INVEST user story
As Thor (Product Manager), I will plan and deliver my responsibilities so that Avengers Assembly achieves its sprint and PI objectives.
...
### Acceptance criteria
- Responsibilities delivered: Integration strategy, system-level requirements, validation criteria
