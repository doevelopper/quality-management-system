# Sue Storm — Scrum Master | Fantastic Four Navigation (ART2)
...
### SMART mission
- Specific: Execute scrum master responsibilities for Fantastic Four Navigation, ensuring alignment to architecture, roadmap, and ceremonies.
- Measurable: Deliver agreed outcomes per sprint/PI; meet KPIs defined below; complete integration points on schedule.
- Achievable: Leverage team capabilities (Sensor integration, Stealth technology developers) and skills (Stealth Operations, Protection, Invisible Barriers), escalating blockers early.
...
### INVEST user story
As Sue Storm (Scrum Master), I will plan and deliver my responsibilities so that Fantastic Four Navigation achieves its sprint and PI objectives.
...
- Valuable: Outcomes increase capability, quality, or flow for Fantastic Four Navigation.
...
### Acceptance criteria
- Responsibilities delivered: Facilitates sensor fusion and stealth systems team
