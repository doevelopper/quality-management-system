# Viv Vision — Senior AI/ML Engineer | Fantastic Four Navigation (ART 2)


## SMART mission
- Specific: Deliver high-quality outcomes as Senior AI/ML Engineer for Fantastic Four Navigation, aligned to backlog priorities and integration needs.
...
As Viv Vision (Senior AI/ML Engineer), I will decompose work into small, testable tasks that deliver value for Fantastic Four Navigation and can be estimated and negotiated with stakeholders.
...
- Quality (defect rate/rework related to Senior AI/ML Engineer)
