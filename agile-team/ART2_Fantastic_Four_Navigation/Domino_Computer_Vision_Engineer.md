# Domino — Computer Vision Engineer | Fantastic Four Navigation (ART 2)
...
As Domino (Computer Vision Engineer), I will decompose work into small, testable tasks that deliver value for Fantastic Four Navigation and can be estimated and negotiated with stakeholders.
