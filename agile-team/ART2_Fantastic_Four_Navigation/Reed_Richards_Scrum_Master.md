# Reed Richards — Scrum Master | Fantastic Four Navigation (ART2)
...
- Achievable: Leverage team capabilities (AI/ML engineers, Computer Vision specialists) and skills (Flexibility, Problem Solving, Scientific Method), escalating blockers early.
...
### INVEST user story
As Reed Richards (Scrum Master), I will plan and deliver my responsibilities so that Fantastic Four Navigation achieves its sprint and PI objectives.
...
### Acceptance criteria
- Responsibilities delivered: Facilitates autonomous navigation team
