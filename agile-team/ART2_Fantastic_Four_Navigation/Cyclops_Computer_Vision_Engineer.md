# Cyclops — Computer Vision Engineer | Fantastic Four Navigation (ART 2)


## SMART mission
- Specific: Deliver high-quality outcomes as Computer Vision Engineer for Fantastic Four Navigation, aligned to backlog priorities and integration needs.
...
As Cyclops (Computer Vision Engineer), I will decompose work into small, testable tasks that deliver value for Fantastic Four Navigation and can be estimated and negotiated with stakeholders.
...
- Quality (defect rate/rework related to Computer Vision Engineer)
