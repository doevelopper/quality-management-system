# Viv Vision — Autonomous Systems Engineer | Fantastic Four Navigation (ART 2)


## SMART mission
- Specific: Deliver high-quality outcomes as Autonomous Systems Engineer for Fantastic Four Navigation, aligned to backlog priorities and integration needs.
...
- Relevant: Directly advances Fantastic Four Navigation's specializations (AI/ML, Computer Vision, Autonomy) within ART 2.
- Time-bound: Operate on a two-week sprint cadence with daily reporting and PI boundary commitments.

## INVEST working story
As Viv Vision (Autonomous Systems Engineer), I will decompose work into small, testable tasks that deliver value for Fantastic Four Navigation and can be estimated and negotiated with stakeholders.
...
- Valuable: Outcomes enhance Fantastic Four Navigation's capabilities (AI/ML, Computer Vision, Autonomy).
...
- Quality (defect rate/rework related to Autonomous Systems Engineer)
