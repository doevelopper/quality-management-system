# Reed Richards — Scrum Master | Fantastic Four Intelligence (ART6)
...
- Achievable: Leverage team capabilities (Machine learning engineers, Algorithm specialists) and skills (Elasticity (Flexible Algorithms), Scientific Genius, Problem Solving), escalating blockers early.
...
### INVEST user story
As Reed Richards (Scrum Master), I will plan and deliver my responsibilities so that Fantastic Four Intelligence achieves its sprint and PI objectives.
...
### Acceptance criteria
- Responsibilities delivered: Facilitates AI/ML algorithm team
