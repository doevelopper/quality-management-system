# Wasp — Swarm Algorithm Engineer | X-Men Swarm (ART 6)
...
As Wasp (Swarm Algorithm Engineer), I will decompose work into small, testable tasks that deliver value for X-Men Swarm and can be estimated and negotiated with stakeholders.
