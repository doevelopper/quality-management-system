# Multiple Man — Swarm Algorithm Engineer | X-Men Swarm (ART 6)


## SMART mission
- Specific: Deliver high-quality outcomes as Swarm Algorithm Engineer for X-Men Swarm, aligned to backlog priorities and integration needs.
...
- Relevant: Directly advances X-Men Swarm's specializations (AI/ML, Swarm Algorithms, Formation Control) within ART 6.
- Time-bound: Operate on a two-week sprint cadence with daily reporting and PI boundary commitments.

## INVEST working story
As Multiple Man (Swarm Algorithm Engineer), I will decompose work into small, testable tasks that deliver value for X-Men Swarm and can be estimated and negotiated with stakeholders.
...
- Valuable: Outcomes enhance X-Men Swarm's capabilities (AI/ML, Swarm Algorithms, Formation Control).
...
- Quality (defect rate/rework related to Swarm Algorithm Engineer)
