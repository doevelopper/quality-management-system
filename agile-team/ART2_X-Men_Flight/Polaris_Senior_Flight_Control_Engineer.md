# Polaris — Senior Flight Control Engineer | X-Men Flight (ART 2)


## SMART mission
- Specific: Deliver high-quality outcomes as Senior Flight Control Engineer for X-Men Flight, aligned to backlog priorities and integration needs.
...
- Relevant: Directly advances X-Men Flight's specializations (Flight Control, Navigation, Sensors) within ART 2.
- Time-bound: Operate on a two-week sprint cadence with daily reporting and PI boundary commitments.

## INVEST working story
As Polaris (Senior Flight Control Engineer), I will decompose work into small, testable tasks that deliver value for X-Men Flight and can be estimated and negotiated with stakeholders.
...
- Valuable: Outcomes enhance X-Men Flight's capabilities (Flight Control, Navigation, Sensors).
...
- Quality (defect rate/rework related to Senior Flight Control Engineer)
