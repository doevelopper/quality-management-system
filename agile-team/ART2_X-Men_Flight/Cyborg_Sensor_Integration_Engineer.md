# Cyborg — Sensor Integration Engineer | X-Men Flight (ART 2)


## SMART mission
- Specific: Deliver high-quality outcomes as Sensor Integration Engineer for X-Men Flight, aligned to backlog priorities and integration needs.
...
As Cyborg (Sensor Integration Engineer), I will decompose work into small, testable tasks that deliver value for X-Men Flight and can be estimated and negotiated with stakeholders.
...
- Quality (defect rate/rework related to Sensor Integration Engineer)
