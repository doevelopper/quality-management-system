# Professor X — Product Manager | X-Men Flight (ART2)
...
### SMART mission
- Specific: Execute product manager responsibilities for X-Men Flight, ensuring alignment to architecture, roadmap, and ceremonies.
- Measurable: Deliver agreed outcomes per sprint/PI; meet KPIs defined below; complete integration points on schedule.
- Achievable: Leverage team capabilities (cross-functional team) and skills (Strategic Vision, Mind Reading (Requirements Understanding), Team Coordination), escalating blockers early.
...
### INVEST user story
As Professor X (Product Manager), I will plan and deliver my responsibilities so that X-Men Flight achieves its sprint and PI objectives.
...
- Valuable: Outcomes increase capability, quality, or flow for X-Men Flight.
...
### Acceptance criteria
- Responsibilities delivered: Airborne systems roadmap, requirement analysis, stakeholder engagement
