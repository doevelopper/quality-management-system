# Forge — Scrum Master | X-Force Propulsion (Electronic Speed Controller - ESC) (ART2)
...
### SMART mission
- Specific: Execute scrum master responsibilities for X-Force Propulsion (Electronic Speed Controller - ESC), ensuring alignment to architecture, roadmap, and ceremonies.
- Measurable: Deliver agreed outcomes per sprint/PI; meet KPIs defined below; complete integration points on schedule.
- Achievable: Leverage team capabilities (Embedded systems engineers, Power electronics specialists, Control engineers) and skills (Mechatronics, Power Electronics, Control Systems), escalating blockers early.
...
### INVEST user story
As Forge (Scrum Master), I will plan and deliver my responsibilities so that X-Force Propulsion (Electronic Speed Controller - ESC) achieves its sprint and PI objectives.
...
- Valuable: Outcomes increase capability, quality, or flow for X-Force Propulsion (Electronic Speed Controller - ESC).
...
### Inputs and outputs
- Inputs: Backlog items, architectural guidance, data dependencies: See Critical Integration Points: [Data & Analytics ↔ Airborne (ESC)](#cip-data-esc) for telemetry schemas, ingestion, and KPI dashboards, team capacity, Definition of Ready.
...
### Acceptance criteria
- Responsibilities delivered: Facilitates ESC hardware/firmware development and control tuning
